...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('bookings', '0003_remove_booking_is_active'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phonenumber', models.CharField(max_length=15, unique=True, validators=[django.core.validators.RegexValidator('^\\+?1?\\d{9,15}$', "Номер телефону повинен бути у форматі: '+380XXXXXXXXX'.")], verbose_name='Номер телефону')),
